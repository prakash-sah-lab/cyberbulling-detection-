...
<div  >
	...
	String sql="select distinct id,name from request where id!='"+id+"'  and status = '"+status+"'";
	try
	{
		...
		<div style="position:absolute; left:550px; top:225px; width: 358px; height: 166px;">
		
		<fieldset>
      
   <legend><font color="#FF8000"><strong><font size="4">Chat</font></strong></font></legend>
		<table align="center" height="150">
			...
			<tr>
            <td><a href="chatting.jsp?name=<%=rs2.getString("name")%>"><font color="green"><strong>Chat</strong></font></a></td>
                <!--&nbsp;&nbsp;&nbsp;<a href="ignore.jsp?id=<%=rid2%>"><font color="red"><strong>Ignore</strong></font></a>-->
          </tr>
			<%}%>
		</table>
		</fieldset>
