...
<br></br><br></br><br></br><br></br><br></br><div  class="form" >
          <h2>It'z Me!&nbsp; 
       <font color="blue"><font size="5"> <%=name%></font></font>
        </h2>
        <form id="contactform" enctype="multipart/form-data" action="searchaction1.jsp" method="get"> 
            <p class="contact"><label for="search" style="font-size: 20px">Find Friends</label></p><br> 
                        <input id="name" name="search" placeholder="Search" tabindex="1" type="text"><br> 
                        <br>
