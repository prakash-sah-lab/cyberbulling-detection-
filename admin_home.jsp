...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="login">
        ...
        <div id="nav">
            ...
            <br></br><a href="admin_home.jsp">
                MALICIOUS USER</a><br><a href="b_user.jsp">
                        BLOCKED USER DETAILS</a><br>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div style="border: 1px solid white;height: 350px;border-top-width: 0px;border-bottom-width: 0px; width: 700px">
                                    <center><h3>MALICIOUS USER DETAILS</h3></center><br />
                                    <table border="1" style="text-align: center;margin-left: 180px">
                                        <tr>
                                            ...
                                            <th style="text-align: center;width: 400px;">Unwanted Message</th>
                                        ...
                                        <tr>
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    rs = st.executeQuery("select * from cyber where cyber='No'");
                                                    while (rs.next()) {
                                            ...
                                            <td><%=rs.getString("cybermessage")%></td>     
                                            <td><a href="de_ac.jsp?<%=rs.getString("email")%>"><font style="color: red">block</a></font> </td>   
